  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
              ...
              <div className="mx-auto w-full max-w-sm">
                ...
                <div className="p-4 pb-0">
                  <p className="text-sm text-muted-foreground">
                    This drawer overlays the page content without pushing it away. You can add forms, lists, or any other components here.
                  </p>
                </div>
                <DrawerFooter>
      ...
      <main className="flex-1 py-6 px-4 lg:px-6 overflow-auto">
        ...
        <p className="mb-4">
          This is a sample page demonstrating how the drawer component overlays the page content.
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>Drawer overlays content without pushing it</li>
